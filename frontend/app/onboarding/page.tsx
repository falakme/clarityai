  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-2xl flex-col px-5 py-8">
      ...
      <div className="mt-6 flex items-center gap-2" aria-label={`Step ${step} of 3`}>
        {[1, 2, 3].map((n) => (
          <span
            key={n}
            className={
              "h-2 flex-1 rounded-full " + (n <= step ? "bg-primary" : "bg-muted")
            }
          />
        ))}
      </div>
      ...
      <section className="flex flex-1 flex-col justify-center py-10">
            ...
            <div className="mt-8 space-y-6">
              ...
              <div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <span className="min-w-[3ch] text-center text-3xl font-bold">
                    {familySize}
                  </span>
                  <Button
                    variant="outline"
        ...
        {step === 3 && (
          <Card>
            <span className="flex h-14 w-14 items-center justify-center rounded-md bg-warning/15 text-amber-600">
